...
# This study consists of single-cell RNA sequencing of murine cardiac tissue 3
# and 7 days after myocardial infarction.
...
# Make a results directory if there isnt one already
...
# Here is an example of loading in data from a typical 10x Genomics cellranger
# pipeline, this is generally what you would recieve from a core facility after
...
# creating a Seurat object from a large (non-sparse) matrix requires a lot of
# memory. To speed things up we have prepared the seurat object before hand,
...
# you will receieve the information on the object.
# Features are genes, samples are cells.
TIP
...
# Below we find differentially expressed genes between clusters 7 and 0.
...
# genes between MI day 7 and day 3 in cluster 7.
head(TIP@meta.data)
...
# a cellular "identity".
head(Idents(TIP)) # be sure the current default identity is the cluster numbers
